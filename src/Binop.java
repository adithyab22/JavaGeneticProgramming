...
public abstract class Binop extends Node {
	...
	/**
	 * returns size of left child tree and right child tree including self (1)
	 */
	public int mySize() {
		return lChild.mySize() + rChild.mySize() + 1;
	}
	 ...
	 * whether the cuurrent node is the parent, or the parent is in the left
