...
public class DataSet {
	...
	/**
	 * Creates a DataSet from the contents of a file. The file must be in the
	 * following format, with each entry separated from the next by whitespace.
	 * <ol>
	 ...
	 * <li>A whitespace-separated list of the X-values corresponding to the
	 * Y-value
	 * </ol>
	 * </ol>
