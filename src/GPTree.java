...
public class GPTree implements Comparable {
	 ...
	 */
	public GPTree(OperatorFactory o, TerminalFactory t, int maxDepth,
			Random rand) {
	...
	/**
	 * Evaluate this GPTree for all the rows in a DataSet, and set its fitness
	...
	/**
	 * Specifies the natural ordering, based on the value of the fitness member
	 * variable.
	 */
